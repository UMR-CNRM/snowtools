...
CONTAINS
  ...
  SUBROUTINE READ_OUTPUT_GRID(FILE_ID_GEO,PZSOUT,KMASSIFOUT,PASPECTOUT,IRANK,&
          GT,ILENDIM,PLATOUT,PLONOUT,PYOUT,PXOUT,PSLOPEOUT,KSTATIONOUT)
  ...
  SUBROUTINE READ_NC(IDFICNC,KZSIN,KMASSIFIN,KASPECTIN, ZSLOPEIN)
    ...
    REAL,DIMENSION(:),ALLOCATABLE, INTENT(OUT):: ZSLOPEIN ! Slope of the input data points
...
! Read altitude massif numbers and aspects
    CALL READ_OUTPUT_GRID(FILE_ID_GEO,ZZSOUT,IMASSIFOUT,ZASPECTOUT,IRANK, &
          ...
          ZSLOPEOUT,ISTATIONOUT)
    PRINT*, MINVAL(IMASSIFOUT,MASK=IMASSIFOUT/=0), MAXVAL(IMASSIFOUT)
    IMASSIVE_DIM_SIZE_OUT = 2
    DO IM = MINVAL(IMASSIFOUT,MASK=IMASSIFOUT/=0)+1, MAXVAL(IMASSIFOUT)-1
