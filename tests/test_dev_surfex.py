...
class s2mTest(unittest.TestCase):
    def setUp(self):
        self.diroutput = os.environ["SNOWTOOLS_CEN"] + "/tests/fail_test/output" + datetime.datetime.today().strftime("%Y%m%d%H%M%S%f")
        self.path_namelist = os.environ["SNOWTOOLS_CEN"] + "/tests/namelists/"
        self.namelist = os.environ["SNOWTOOLS_CEN"] + "/tests/namelists/namelist.nam"
        self.forcingtest = os.environ["SNOWTOOLS_CEN"] + "/DATA/FORCING_test_base.nc"
...
class s2mTestForcageImpurete(s2mTest):
    ...
    def setUp(self):
        ...
        self.forcingtest = os.environ["SNOWTOOLS_CEN"] + "/DATA/FORCING_test_impur.nc"
        self.commonoptions = " -o " + self.diroutput + " -f " + self.forcingtest + " -n " + self.namelist + " -g"
...
class s2m2DTest(s2mTest):
    ...
    def setUp(self):
        ...
        self.forcingtest = os.environ["SNOWTOOLS_CEN"] + "/DATA/FORCING_test_2d.nc"
        self.namelist = os.environ["SNOWTOOLS_CEN"] + "/DATA/OPTIONS_test_2d.nam"
