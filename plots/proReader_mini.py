...
class ProReader_mini:
    ...
    def plot_date(self, axe, var, date=None, legend=None, color='b', cbar_show=True, top=None):
    ...
    def plot_date_complet(self, axe, axe2, var, date=None, legend=None, color='b', cbar_show=False, top=None):
