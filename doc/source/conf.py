...
sys.path.insert(0, os.path.abspath('../../vortex-cen/src'))  # Folder inside the vortex-cen plugin
...
htmlhelp_basename = 'Snowtoolsdoc'
...
latex_documents = [
    (master_doc, 'Snowtools.tex', 'Snowtools Documentation',
     'Centre d\'Études de la Neige, Météo-France, CNRS', 'manual'),
]
...
man_pages = [
    (master_doc, 'snowtools', 'Snowtools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Snowtools', 'Snowtools Documentation',
     author, 'Snowtools', 'One line description of project.',
     'Miscellaneous'),
]
