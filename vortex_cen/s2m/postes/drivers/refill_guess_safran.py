# -*- coding:Utf-8 -*-
"""
Refill SAFRAN guess files to restart real time chain
"""
...
class PrepSafran(Task, CENTaskMixIn):
    ...
    Offline generation of an archive of SAFRAN guess files containing all guess from last 01/08
    to be used by the monthly SAFRAN reanalysis. Missing guess files are created.
    1 execution per S2M domain.

    Inputs
    ------
    - Deterministic safran guess files from 01/08 6H to 6H (J)
    - [For each missing SAFRAN guess file] ARPEGE 6h analysis
