                    ...
                    if dateend == self.conf.dateend:
                        ...
                        if dateend < Date(2002, 8, 1):
                            ...
                            tb01_c = toolbox.input(
                                ...
                                remote         = '/home/vernaym/s2m/[geometry:area]/{0:s}/p{1:s}.tar'.format(self.conf.guess_block, next_season),
                                hostname       = 'hendrix.meteo.fr',
                                unknownflow    = True,
                                username       = 'vernaym',
                                tube           = 'ftp',
...
#                     print
                ...
                # Entre 2002 et 2017 on utilise des guess ARPEGE archivés
                    ...
                    tb01 = toolbox.input(
                        ...
                        remote         = '/home/vernaym/s2m/[geometry:area]/{0:s}/p{1:s}.tar'.format(self.conf.guess_block, season),
                        hostname       = 'hendrix.meteo.fr',
                        unknownflow    = True,
                        username       = 'vernaym',
                        tube           = 'ftp',
