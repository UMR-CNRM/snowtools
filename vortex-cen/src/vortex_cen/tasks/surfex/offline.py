...
# initial pour faire plus court 'ex : "_Offline_Task"
# J'ai supprimé la notion de "Task" qui apparait déjà dans la classe mère _CenResearchTask pour alléger, mais je n'ai rien contre le rajouter si tu trouve ça mieux

# MV : Je fais apparaitre "MPI" dans le nom de la tâche puisqu'il s'agit pour l'instant uniquement des exécutions
# d'OFFLINE avec une parallélisation MPI.
...
class Abstract_Offline_MPI(_CenResearchTask):
    '''
    ...
    - DIAG.nc TODO
    '''
    # MV TODO : Compléter et CHECKER la doc
    ...
    def get_remote_inputs(self):
        ...
        # MV : Les fichiers ECOCLIMAP sont utiles seulement pour l'exécution de PREP ?
        # --> Si oui ne pas les mettre dans la tâche OFFLINE
        ...
        # MV : Idem, si utile seulement pour l'exécution de PREP ne pas les mettre dans la tâche OFFLINE
    ...
    def put_remote_outputs(self):
        ...
        # MV : Les lignes suivantes sont équivalentes à la définition d'une variable
        # "namespace_pro" dans le fichier de conf
...
class Offline_MPI_Uenv(Abstract_Offline_MPI):
    '''
...
class Offline_MPI_Local(Abstract_Offline_MPI):
    '''
